...
3. Ejecuta las migraciones para crear las tablas de la base de datos ejecutando el siguiente comando en la línea de comandos:
    ``php artisan migrate --seed --class=UsersTableSeeder``
    
4. Ejecuta el siguiente comando para iniciar el servidor web de desarrollo:
    ``php artisan serve``
