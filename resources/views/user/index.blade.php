                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td class="text-center">
                                <img src="{{ asset('storage/profile_pics/' . $user->profile_pic) }}" style="height: 50px; width: 50px; border-radius: 20%;">
                            </td>
                            ...
                            <td class="text-right" style="width: 100px;">
                                <form action="{{ route('users.destroy', $user) }}" method="POST" class="eliminar-form">
                                    @csrf
                                    @method('DELETE')
